...
import com.mirfatif.permissionmanagerx.permview.PermViewActivity;

public class PermViewActivityM extends BaseActivity {

  public final PermViewActivity mA = new PermViewActivity(this);
